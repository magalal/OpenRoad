...
//    the "usemtl" statements in the OBJ file.  Faces that use
//    the same material will be grouped into a single face set,
//    even if multiple "usemtl" lines are used to specify them.
//
...
//    a global state.  File name propagation is enabled by
//    default.
//
...
//
//  Class Function: isPathPropagation
//
//  Purpose: To determine whether the ObjLibrary will propagate
//           file paths to files refernced in models and
//           libraries.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: Whether file paths will propagate to referenced
//           files.
//  Side Effect: N/A
//

	static bool isPathPropagation ();

//
//  Class Function: setPathPropagation
//
//  Purpose: To change whether the ObjLibrary will propagate
//           file paths to referenced files.
//  Parameter(s):
//    <1> propagate: Whether file paths should propagate
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: If propagate == true, file paths for models and
//               libraries will be implicitly added to the
//               libraries and textures they reference.
//               Otherwise, the file path will not be implicitly
//               added.
//

	static void setPathPropagation (bool propagate);
...
//           state of an ObjModel after it is created with the
//           default constructor.  It is also the state of an
//           ObjModel after its makeEmpty function is called.
//  Parameter(s): N/A
//  Precondition(s): N/A
...
//        texture_coordinates ==ObjMOdel::NO_TEXTURE_COORDINATES
//  Returns: N/A
...
private:
	...
	struct PointSet
	{
		std::vector<unsigned int> mv_vertices;
	};
	...
	struct Line
	{
		std::vector<LineVertex> mv_vertices;
	};
	...
	struct Face
	{
		std::vector<FaceVertex> mv_vertices;
	};
...
private:
	static bool ms_is_path_propagation;
